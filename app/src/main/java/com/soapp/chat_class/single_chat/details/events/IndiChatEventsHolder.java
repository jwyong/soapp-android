...
public class IndiChatEventsHolder extends RecyclerView.ViewHolder {
    //basics
    ...
    IndiChatEventsHolder(View itemView) {
        super(itemView);
    ...
    public void setData(final Appointment data) {
        ...
        itemView.setOnClickListener(v -> {
            Intent intent = new Intent(context, IndiScheLog.class);

            intent.putExtra("jid", IndiChatDetail.jid);
    ...
    public void setDataNoAppt() {
        itemView.setOnClickListener(v -> {
            Intent grpScheIntent = new Intent(context, NewIndiExistApptActivity.class);
            grpScheIntent.putExtra("jid", IndiChatDetail.jid);
