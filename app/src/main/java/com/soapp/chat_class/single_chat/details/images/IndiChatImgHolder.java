...
public class IndiChatImgHolder extends RecyclerView.ViewHolder {
    //basics
    Context context;
    ...
    IndiChatImgHolder(View itemView) {
        super(itemView);
    ...
    public void setData(final Message data) {
        ...
        switch (data.getIsSender()) {
            ...
            case 24:
                mediaPath = GlobalVariables.VIDEO_SENT_THUMBNAIL_PATH + "/" + data.getMsgInfoUrl() + ".jpg";
                isVideo = true;
                break;
            case 25:
