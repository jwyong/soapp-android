package com.soapp.global.DateTime.date;
...
import com.soapp.global.DateTime.HapticFeedbackController;
import com.soapp.global.DateTime.TypefaceHelper;
import com.soapp.global.DateTime.Utils;
...
public class DatePickerDialog extends DialogFragment implements
    ...
    private int mOkResid = R.string.ok_label;
    private String mOkString;
    private int mOkColor = -1;
    private int mCancelResid = R.string.cancel;
     ...
     */
    public static DatePickerDialog newInstance(IndiScheLog indiScheLog, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth);
        return ret;
    }

    public static DatePickerDialog newInstance(GroupScheLog GroupScheLog, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        DatePickerDialog ret = new DatePickerDialog();
        ret.initialize(callBack, year, monthOfYear, dayOfMonth);
        return ret;
    }
    ...
    public static DatePickerDialog newInstance(FoodDetailBookingFragment foodDetailBookingFragment, OnDateSetListener callback, int mYear, int mMonth, int mDay) {
...
//        mSelectedMonthTextView = view.findViewById(R.id.mdtp_date_picker_month);
        ...
        int bgColorResource = mThemeDark ? R.color.black : R.color.white;
    ...
    /**
     * @return The indiScheList of dates, as Calendar Objects, which should be highlighted. null is no dates should be highlighted
     */
    @SuppressWarnings("unused")
    ...
    /**
     * @return an Array of Calendar objects containing the indiScheList with selectable items. null if no restriction is set
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Sets a indiScheList of days which are the only valid selections.
    ...
    /**
     * @return an Array of Calendar objects containing the indiScheList of days that are not selectable. null if no restriction is set
     */
    @SuppressWarnings("unused")
    ...
    /**
     * Sets a indiScheList of days that are not selectable in the picker
