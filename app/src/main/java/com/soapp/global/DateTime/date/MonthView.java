...
public abstract class MonthView extends View {
    ...
    public MonthView(Context context, AttributeSet attr, DatePickerController controller) {
        ...
        if (darkTheme) {
            mDayTextColor = ContextCompat.getColor(context, R.color.white);
            mMonthDayTextColor = ContextCompat.getColor(context, R.color.grey8);
            mDisabledDayTextColor = ContextCompat.getColor(context, R.color.grey9);
            mHighlightedDayTextColor = ContextCompat.getColor(context, R.color.white);
        } else {
            mDayTextColor = ContextCompat.getColor(context, R.color.black);
            mMonthDayTextColor = ContextCompat.getColor(context, R.color.grey9);
            mDisabledDayTextColor = ContextCompat.getColor(context, R.color.grey7);
            mHighlightedDayTextColor = ContextCompat.getColor(context, R.color.black);
        }
        mSelectedDayTextColor = ContextCompat.getColor(context, R.color.white);
