...
import com.soapp.R;
import com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.ArrayWeekDayFormatter;
import com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.DateFormatTitleFormatter;
import com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.DayFormatter;
import com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.MonthArrayTitleFormatter;
import com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.MonthArrayTitleFormatterNoYear;
import com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.TitleFormatter;
import com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    private final ImageView buttonUpDown;
    ...
    private Drawable Button1, Button2;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        buttonSearch = new ImageView(getContext());
//        buttonPast.setContentDescription(getContext().getString(R.string.next));

        title = new TextView(getContext());

        //right button
        buttonUpDown = new ImageView(getContext());
//        buttonUpDown.setContentDescription(getContext().getString(R.string.updown));

        pager = new CalendarPager(getContext());

//        buttonUpDown.setOnClickListener(onClickListener);
...
//                    Color.BLACK
//            ));
            Drawable rightSearch = a.getDrawable(
                    R.styleable.MaterialCalendarView_mcv_leftArrowMask
            );
//            if (rightSearch == null) {
//                rightSearch = getResources().getDrawable(R.drawable.ic_search_grey_70px);
//            }
            setLeftArrowMask(rightSearch);

            Drawable upDownArrow = a.getDrawable(
                    R.styleable.MaterialCalendarView_mcv_rightArrowMask
            );
            if (upDownArrow == null) {
                upDownArrow = getResources().getDrawable(R.drawable.ic_arrow_down_70px);
            }
            setRightArrowMask(upDownArrow);
            ...
            if (array != null) {
                ...
                setTitleFormatter(new MonthArrayTitleFormatterNoYear(array));
            }
...
//        topbar.setGravity(Gravity.CENTER);
        ...
        //up/down btn
        buttonUpDown.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        LinearLayout.LayoutParams layoutUpdown = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1);
//        buttonUpDown.(Gravity.CENTER);
        topbar.addView(buttonUpDown, layoutUpdown);

        title.setGravity(Gravity.CENTER);
        topbar.addView(title, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 4));


        buttonSearch.setScaleType(ImageView.ScaleType.CENTER_INSIDE);

        LinearLayout.LayoutParams searchIcon = new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1);
//        searchIcon.addRule(RelativeLayout.ALIGN_PARENT_END);
        searchIcon.setMargins(15, 0, 0, 0);
        topbar.addView(buttonSearch, searchIcon);
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if (calendarMode == CalendarMode.WEEKS) {
                            setRightArrowMask(getResources().getDrawable(R.drawable.ic_arrow_up_70px));
                            ScheduleTab.ScheduleCalendar.state().edit().setCalendarDisplayMode(CalendarMode.MONTHS).commit();
                        } else {
                            setRightArrowMask(getResources().getDrawable(R.drawable.ic_arrow_down_70px));
                            ScheduleTab.ScheduleCalendar.state().edit().setCalendarDisplayMode(CalendarMode.WEEKS).commit();
...
//        buttonFuture.setEnabled(canGoForward());
    ...
    public void setCurrentMonthByDate(CalendarDay date) {
...
//        buttonFuture.setColor(color);
    ...
    public void setTopbarPadding(int left, int top, int right, int bottom) {

        topbar.setPadding(left, top, right, bottom);
    }

    public void setTopbarMargin() {
...
//        buttonFuture.setContentDescription(description);
    ...
    public void setLeftArrowMask(Drawable icon) {
        leftArrowMask = icon;
        buttonSearch.setImageDrawable(icon);
    }
    ...
    public void setRightArrowMask(Drawable icon) {
        rightArrowMask = icon;
        buttonUpDown.setImageDrawable(icon);
    }
    ...
    /**
     * Set a {@linkplain com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(com.soapp.global.DateTime.DateTimePickerHelper.DateHelper.format.TitleFormatter)
     */
    public void setTitleMonths(CharSequence[] monthLabels) {
        setTitleFormatter(new MonthArrayTitleFormatter(monthLabels));
        setTitleFormatter(new MonthArrayTitleFormatterNoYear(monthLabels));
    }
...
//                goToNext();
    ...
    public class StateBuilder {
         ...
         * currently on.
         *
         * @param cacheCurrentPosition Set to true to cache the current position, false otherwise.T
         */
