...
public class DotSpan2 implements LineBackgroundSpan {
     ...
     * @param color  color of the dot
     */
    public DotSpan2(float radius, int color) {
        this.radius = radius;
        this.color = color;
    }
